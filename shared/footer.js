...
//
// Plain script, not a module (see config.js for why) -- loaded via a plain
// <script src> before the page's own inline script calls mountFooter().
    ...
    <footer class="site-footer">
      <div class="footer-grid">
        <div>
          ...
          <a href="${basePath}login/index.html">Relaties</a>
          <a href="${basePath}index.html#events">Events</a>
        </div>
        <div>
          <h3>Contact</h3>
        ...
        <div>
          ...
          <span>Veemarkt 237, 1019 CM Amsterdam</span>
          <span>KVK: 69343551</span>
          <span>BTW-nummer: NL857839251.B01</span>
        </div>
      </div>
